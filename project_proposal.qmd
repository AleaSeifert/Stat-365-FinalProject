...
1.  How has the frequency of animal rescues changed over time among different animals?
...
2.  How is the location of the incident associated with cost?
    ...
    Tentative plan: facet by borough and find the average incident cost for each.
...
3.  How is the type of incident associated with the time of year?
    ...
    Tentative plan: filter date_time_of_call into the four seasons
